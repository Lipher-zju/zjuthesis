...
\documentclass[
    ...
    % Thesis Info
    StudentName     = 李赫,
    StudentID       = 3200102858,
    AdvisorName     = 尹建伟,
    Grade           = 2020,            % only the year, no '级'
    Major           = 人工智能,
    Department      = 计算机科学与技术学院,
    SubmitDate      = 2024年5月20日,
    MajorFormat     = general,
    ...
    % Title
    Title           = 基于大模型的数字服务监管语言设计,
    TitleEng        = {{The Design of Digital Service Supervision Language Based on Large Models}}
]{zjuthesis}

%% Uncomment the following lines if you need multi line titles on cover pages
\titletwolines{基于大模型的数字}{服务监管语言设计}
